...
The package is still under development (ver. 0.1.1 - alpha) and may contain bugs. Currently, it is just a set of functions. The package also lacks a complete documentation.
